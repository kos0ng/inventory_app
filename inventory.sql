...
--
-- Host: localhost
-- Generation Time: Apr 15, 2021 at 08:40 AM
...
('B000002', 'Samsung Galaxy J1 Ace', 84, 1, 4),
('B000003', 'Aqua 1,5 Liter', 700, 3, 2),
('B000004', 'Mouse Wireless Logitech M220', 5, 1, 7);
...
('T-BK-21041500007', 3, 'B000002', 10, '2021-04-15');
...
('T-BM-21041500009', 2, 3, 'B000002', 10, '2021-04-15'),
('T-BM-21041500010', 1, 3, 'B000002', 12, '2021-04-15');
...
CREATE TABLE `users` (
  ...
  `foto` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'default.png',
...
INSERT INTO `users` (`id_user`, `name`, `email`, `email_verified_at`, `password`, `remember_token`, `created_at`, `updated_at`, `no_telp`, `role`, `foto`, `is_active`) VALUES
(1, 'coba', 'coba@gmail.com', NULL, '$2y$10$pVRd.igjKC6/oczZKXvY7OCz6Nk75BsFuPlZJj3ixbr9WW1yJvQpC', NULL, NULL, NULL, '', 1, 'default.png', 0),
(2, 'asd', 'asd@gmail.com', NULL, '$2y$10$i7CNIW.1UacCEIWeePgFQuEIKEfdrM3g.HUeIclTGepAQRzGUgWnC', NULL, '2021-04-14 19:45:40', '2021-04-14 22:30:19', '123123123123123', 2, 'default.png', 1),
(3, 'kosonga', 'kosong@gmail.com', NULL, '$2y$10$J7tZXcjLrRX4dKcuucnncuFxl20wLuN/DAsgytJxKhPgTZS7DLz8K', NULL, '2021-04-14 19:54:09', '2021-04-14 22:22:10', '1231231231231', 1, '1618463173.jpg', 1);
...
--
ALTER TABLE `barang_keluar`
  ADD CONSTRAINT `barang_keluar_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `users` (`id_user`) ON DELETE CASCADE ON UPDATE CASCADE,
...
--
ALTER TABLE `barang_masuk`
  ADD CONSTRAINT `barang_masuk_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `users` (`id_user`) ON DELETE CASCADE ON UPDATE CASCADE,
